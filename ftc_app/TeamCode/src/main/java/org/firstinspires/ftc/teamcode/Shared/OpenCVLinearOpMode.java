...
public abstract class OpenCVLinearOpMode extends OpMode {
    ...
    private OpenCVLinearOpMode.LinearOpModeHelper helper          = null;
    ...
    final public void init() {
        ...
        this.helper          = new OpenCVLinearOpMode.LinearOpModeHelper();
    ...
    protected class LinearOpModeHelper implements Runnable {
        ...
        public void run() {
            ThreadPool.logThreadLifeCycle("LinearOpMode main", new Runnable() { @Override public void run() {
                ...
                try {
                    OpenCVLinearOpMode.this.runOpMode();
                    requestOpModeStop();
